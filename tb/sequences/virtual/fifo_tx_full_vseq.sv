///////////////////////////////////////////////////////////////////////////////
// File:        fifo_tx_full_vseq.sv
// Description: Corner case fifo_tx_full.
//              TX ready casi siempre bajo para llenar la TX FIFO.
///////////////////////////////////////////////////////////////////////////////

class fifo_tx_full_vseq extends uvm_sequence;
  `uvm_object_utils(fifo_tx_full_vseq)

  function new(string name = "fifo_tx_full_vseq");
    super.new(name);
  endfunction
  ...
  task body();
    ...
    if (!$cast(vseqr, m_sequencer))
      `uvm_fatal("FIFO_TX_FULL_VSEQ", "cast a aligner_vsequencer falló")
    ...
    fork
      ...
      begin
        // Backpressure muy alto para llenar TX FIFO
